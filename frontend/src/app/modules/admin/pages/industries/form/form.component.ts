...
import { reset, set } from 'src/app/shared/actions/formSubmitted.actions';
...
export class FormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.nameMultilanguageInputConfig.formArray = this.createForm.get(
      'name'
    ) as FormArray;
  ...
  private initializeComponents() {
    ...
    this.cardFooterConfig.cancelAction = function () {
      scope.goToList();
    };
    this.cardFooterConfig.deleteAction = function () {
      scope.onDelete();
    };
